                                ...
                                <div className="col-5 col-md-5 col-lg-6 col-xl-6">
                                    <div className="d-flex justify-content-center">
                                        <div className="input-group mr-2">
                                            <input disabled={true} type="text" className="form-control" placeholder={`Search by ${_.toLower(_.trimEnd(decorateTitle(pathname),'s'))} name, email, phone number`} aria-label="Recipient's username" aria-describedby="basic-addon2" />
