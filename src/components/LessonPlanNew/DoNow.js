                    ...
                    <div class="d-flex flex-row questions-box col-sm-7 pl-0 pr-0">
                        <div class="p-3 col-sm-4">
                            ...
                            <ul className="questions-list-up">
                                ...
                                <li><a><img src={donow2} alt="" />Image</a></li>
                                <li><a><img src={donow3} alt="" />Video</a></li>
                                <li><a><img src={donow4} alt="" />Text</a></li>
                            </ul>
                        </div>
                        <div class="p-3 col-sm-8">
                            ...
                            <ul className="questions-list">
                                ...
                                <li><a><img src={donow6} alt="" />Multiple Selection</a></li>
                                <li><a><img src={donow10} alt="" />Upload PDF</a></li>
                                <li><a><img src={donow7} alt="" />Short Answer</a></li>
                                <li><a><img src={donow11} alt="" />Image</a></li>
                                <li><a><img src={donow8} alt="" />Blank Space</a></li>
                                <li><a><img src={donow12} alt="" />Doc Document</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
